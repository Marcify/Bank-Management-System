...
public class DepositForm extends javax.swing.JFrame {
    ...
    public DepositForm(Customer customer) {
        ...
        try {
            URL iconUrl = getClass().getResource("/deposit.png");
            if (iconUrl != null) {
                setIconImage(new ImageIcon(iconUrl).getImage());
            } else {
                System.err.println("Icon not found at /deposit.png");
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/deposit.png"))); // NOI18N
